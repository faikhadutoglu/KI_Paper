...
\begin{figure}[!t]
	\centering
	\includegraphics[width=2in]{crossNN_modell.jpeg}
	\caption{Visualisierung eines KI-Modells(crossNN) zur Tumordiagnostik. Jeder Punkt steht für das Profil eines Referenztumors; Farben markieren unterschiedliche Tumortypen. Trainiert an über 8000 Referenztumoren, validiert an über 5000 Proben. 99,1\,\% Genauigkeit bei Hirntumoren; weiteres Modell unterscheidet über 170 Tumorarten mit 97,8\,\%. Quelle: Charité \cite{ref:charite_crossnn}}
	\label{fig:crossNN_modell}
\end{figure}
...
\section*{KI-Nutzungsnotiz}
Bei der Erstellung dieser Arbeit wurden folgende KI-Tools unterstützend eingesetzt:

\begin{itemize}
	\item \textbf{DeepL:} Übersetzung fremdsprachiger Quellen.
	\item \textbf{ChatGPT/Claude:} Unterstützung bei LaTeX-Befehlen und Codekorrekturen, Gliederungshilfe, Zusammenfassung von Quellen, Formulierungshilfe und Korrektur.
	\item \textbf{Perplexity:} Quellenrecherche.
\end{itemize}
	% ===================== REFERENCES ==============================
...
%dieser Abschinit haben wir nicht mehr !!
%\bibitem{ref:3b1b}
...
\bibitem{ref:charite_crossnn}
Charité – Universitätsmedizin Berlin, ``Tumordiagnostik: KI-Modell erkennt mehr als 170 Krebsarten,'' Pressemitteilung, 06.06.2025. [Online]. Verfügbar unter: 
\url{https://www.charite.de/service/pressemitteilung/artikel/detail/tumordiagnostik_ki_modell_erkennt_mehr_als_170_krebsarten} 
(letzter Zugriff: 09.12.2025).
